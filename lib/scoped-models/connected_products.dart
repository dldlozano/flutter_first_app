...
mixin ProductsModel on ConnectedProductsModel {
  ...
  Future<bool> addProduct(
    ...
    try {
      final http.Response response = await http.post(
          'https://fir-products-e8d82.firebaseio.com/products.json?auth=${_authenticatedUser.token}',
  ...
  Future<bool> deleteProduct() {
    ...
    return http
        .delete(
            'https://fir-products-e8d82.firebaseio.com/products/${deletedProductId}.json?auth=${_authenticatedUser.token}')
  ...
  Future<Null> fetchProducts({onlyForUser = false}) {
    ...
    return http
      ...
      _products = productList.where((Product product){
        if(onlyForUser) {
  ...
  Future<bool> updateProduct(
    ...
    return http
        .put(
            'https://fir-products-e8d82.firebaseio.com/products/${selectedProduct.id}.json?auth=${_authenticatedUser.token}',
  ...
  void toggleProductFavoriteStatus() async {
    ...
    if (newFavoriteStatus) {
      response = await http.put(
        'https://fir-products-e8d82.firebaseio.com/products/${selectedProduct.id}/wishlistUsers/${_authenticatedUser.id}.json?auth=${_authenticatedUser.token}',
